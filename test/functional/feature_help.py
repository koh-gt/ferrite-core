...
"""Verify that starting ferrite with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ferrite with -h for help text")
        ...
        self.log.info("Start ferrite with -version for version information")
        ...
        self.log.info("Start ferrited with -fakearg to make sure it does not start")
