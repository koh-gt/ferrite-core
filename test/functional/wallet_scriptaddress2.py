...
#
# Test new Ferrite multisig prefix functionality.
#
...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3g89",
        ...
        assert_equal(multisig_addr_new, 'Z974ZrPrmqMmm1PSVp4m8YEgo3bCZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYbmLTWPjq"
