# Support for Output Descriptors in Ferrite Core

Since Ferrite Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `fec1...` for mainnet or `tfec1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Ferrite's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ferrite Core wallets, a convenience function `combo` is
