...
Codesigner only: Sign the macOS binary:
    ...
    $   xcrun altool --notarize-app --primary-bundle-id "org.ferrite.Ferrite-Qt" -u "<apple-id-email>" -p "@keychain:<apple-id-notarisation-app-specific-password>" --asc-provider <team-id-shortcode> -t osx -f ferrite-${VERSION}-osx.dmg
    ...
    $   xcrun stapler staple dist/Ferrite-Qt.app
...
Codesigner only: Commit the detached codesign payloads:
    ...
    cp dist/Ferrite-Qt.app/Contents/CodeResources osx/dist/Ferrite-Qt.app/Contents/
    git add -A
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-signed --destination ../gitian.sigs/ ../ferrite/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-win-signed ../ferrite/contrib/gitian-descriptors/gitian-win-signer.yml
...
ferrite-${VERSION}-riscv64-linux-gnu.tar.gz
...
space *do not upload these to the ferrite.org server, nor put them in the torrent*.
