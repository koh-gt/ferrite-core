    ...
    platformStyle(_platformStyle)
{
    ...
    sendFextPage = new SendFextPage(platformStyle);
    sendFextPage->setModel(walletModel);
...
void WalletView::gotoSendFextPage()
{
    setCurrentWidget(sendFextPage);
}
