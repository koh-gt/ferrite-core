...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ferrite Core developer"
...
#define PACKAGE_BUGREPORT "https://github.com/koh-gt/ferritecoin-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ferrite Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ferrite Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ferrite"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://ferriteco.in/"
