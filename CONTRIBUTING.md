...
Most communication about Ferrite Core development happens on IRC, in the
#ferrite-dev channel on Freenode. The easiest way to participate on IRC is
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/ferrite-dev)
...
The following applies to code changes to the Ferrite Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ferrite
Network Protocol consensus changes.

Whether a pull request is merged into Ferrite Core rests with the project merge
