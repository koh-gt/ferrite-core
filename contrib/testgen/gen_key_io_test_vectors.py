...
bech32_templates = [
  ...
  ('fec',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('fec',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('fec',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tfec',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tfec',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tfec',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rfec',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rfec',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rfec', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tfec',  17, 32, False, False, False),
  ('rfec',  3,  1, False, False, False),
  ('fec',   15, 41, False, False, False),
  ('tfec',  0, 16, False, False, False),
  ('rfec',  0, 32, True,  False, False),
  ('fec',   0, 16, True,  False, False),
  ('tfec',  0, 32, False, True,  False),
  ('rfec',  0, 20, False, False, True)
]
