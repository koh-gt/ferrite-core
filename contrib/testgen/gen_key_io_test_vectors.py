...
bech32_templates = [
  ...
  ('fec',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('fec',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('fec',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('fec',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tfec',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfec',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfec',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfec',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tfec',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfec',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfec',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfec',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rfec',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rfec',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rfec',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rfec', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tfec',   17, 32, Encoding.BECH32M, False, False, False),
  ('rfec',  3,  1, Encoding.BECH32M, False, False, False),
  ('fec',   15, 41, Encoding.BECH32M, False, False, False),
  ('tfec',    0, 16, Encoding.BECH32,  False, False, False),
  ('rfec',  0, 32, Encoding.BECH32,  True,  False, False),
  ('fec',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tfec',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rfec',  0, 20, Encoding.BECH32,  False, False, True),
  ('fec',    0, 20, Encoding.BECH32M, False, False, False),
  ('tfec',    0, 32, Encoding.BECH32M, False, False, False),
  ('rfec',  0, 20, Encoding.BECH32M, False, False, False),
  ('fec',    1, 32, Encoding.BECH32,  False, False, False),
  ('tfec',    2, 16, Encoding.BECH32,  False, False, False),
  ('rfec', 16, 20, Encoding.BECH32,  False, False, False),
]
